...
import io.github.jan.supabase.storage.storage
import ru.khubulty.cloudgallery.BuildConfig
import ru.khubulty.cloudgallery.data.UsersRepoImpl
...
object MainActivityModule {
    ...
    @Provides
    @Singleton
    fun provideRepo(postgrest: Postgrest): UsersRepository = UsersRepoImpl(postgrest)
}